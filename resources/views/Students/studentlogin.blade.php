            ...
            <div class="col-lg-5 col-md-7 col-sm-10">
                <div class="card">
                    <div class="card-header">
                        <h5 class="text-center text-info">Student Login</h5>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="mb-3">
                                <a class="text-decoration-none text-danger" href="{{ route('student.resetpass') }}">Forgot password?</a>
                            </div>
            ...
            $.ajax({
                ...
                success: function(res){
                    if (res.status == 400) {
                        ...
                        $('#login_btn').val('LOGIN');
                        window.location = '{{ route('studentdashboard') }}'
                    }
                }
            })
        })
