    ...
    <div class="modal-content">
        ...
        <div class="col-lg-6 col-md-8 col-sm-12">
         ...
         <div class="form-group mb-2">
            ...
            <input type="text" name="username1" id="username1" class="form-control" readonly> 
         </div>
            ...
            <div class="col-lg-6 col-md-7 col-sm-10">
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="mb-3">
                                <label for=""><h6 class="text-danger">Enter your username</h6></label>
        ...
        $('#resetpasswordform').submit(function(e){
            ...
            if (pass !== npass) {
                ...
                success: function(res){
                    ...
                    $("#passresetdiv").html('<div class="alert alert-success alert-dismissible w3-animate-zoom show" role="alert"><p>You have successfully reset your password. Your new password is <b>'+res.password+'</b> and username is <b>'+res.username+'. Click to <a href="/studentlogin">LOG IN</a></b></p><button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>');
                }
            })  
            } 
        })
