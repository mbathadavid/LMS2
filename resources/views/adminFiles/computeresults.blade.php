...
<button class="btn btn-sm btn-success" type="submit">UPLOAD MARKS FOR <span id="subject3"></span></button>
</div>
</form>
</div>

<div id="marksviewdiv" class="row w3-animate-right">
    <h6 id="alertmarks" class="text-center text-danger d-none">Some previously added marks for <b><span id="addedsubject"></span></b> were found.You can either delete and add afresh or edit.</h6>
    ...
    <form id="withoutmarksadd" style="background-color: #d9d9d9" class="d-none mt-2 p-3" action="#">
        <h6 class="text-center text-danger">Marks for the following students were not found. Click <b>Add</b> to add their marks</h6>
        <div class="table-responsive">
            <table class="table">
                <thead>
                    <tr>
        ...
        <input id="marksadd" type="submit" value="ADD MARKS" class="form-control btn btn-sm btn-danger d-none">
        </div>
    </form>
</div>
@endif
            ...
            $.ajax({
                ...
                success: function(res){
                    ...
                    if (res.student.split(',').includes(item.AdmissionNo)) {
                        ...
                        appenddata2 +='<td><input value="" type="checkbox" name="enablemarksinsert" id="enablemarksinsert"> <span class="text-success"><b>Add</b></span></td>';
                        appenddata2 +='<td><input send="send" readonly disabled type="number" value="'+item.AdmissionNo+'" name="enteradmissionnumber[]" id="enteradmissionnumber" class="form-control"></td>';
                        appenddata2 +='<td><input send="send" readonly disabled type="text" value="'+item.Fname+'" name="enterfirstname[]" id="enterfirstname" class="form-control"></td>';
                        appenddata2 +='<td><input send="send" readonly disabled type="text" value="'+item.Lname+'" name="enterlname[]" id="enterlname" class="form-control"></td>';
                        appenddata2 +='<td><input send="send" readonly disabled type="text" value="No marks" name="enterlname[]" id="enterlname" class="form-control"></td>';
                        appenddata2 +='<td><input send="send" readonly disabled type="text" value="" name="entermaxscore[]" id="entermaxscore" class="form-control"></td>';  
                    } 
                    appenddata +='</tr>';
            ...
            $.ajax({
                ...
                success: function(res){
                    ...
                    if (res.student.split(',').includes(item.AdmissionNo)) {
                        ...
                        appenddata2 +='<td><input send="send" readonly disabled type="text" value="'+item.Fname+'" name="enterfirstname[]" id="enterfirstname" class="form-control"></td>';
                        appenddata2 +='<td><input send="send" readonly disabled type="text" value="'+item.Lname+'" name="enterlname[]" id="enterlname" class="form-control"></td>';
                        appenddata2 +='<td><input send="send" readonly type="text" value="No marks" name="enterlname[]" id="enterlname" class="form-control"></td>';
                        appenddata2 +='<td><input send="send" readonly disabled type="text" value="" name="entermaxscore[]" id="entermaxscore" class="form-control"></td>';  
                    } 
                    appenddata +='</tr>';
                    $("#viewmarkstable").append(appenddata);
         ...
         $('#markupdateform').find("input[id='viewmarks']").each(function(i){
          ...
          $.ajax({
             ...
             if(res.status == 401){
                ...
                /*    $('#markupdateform').find("input[id2='updation']").each(function(i){
                    $(this).prop("disabled", !$(this).prop("disabled"));
                    $(this).prop("readonly", !$(this).prop("readonly"));
                    }) */
                } 
