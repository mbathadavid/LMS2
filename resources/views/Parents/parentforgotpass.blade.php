        ...
        $('#resetpasswordform').submit(function(e){
            ...
            if (pass !== npass) {
                ...
                success: function(res){
                    ...
                    $("#passresetdiv").html('<div class="alert alert-success alert-dismissible w3-animate-zoom show" role="alert"><p>You have successfully reset your password. Your new password is <b>'+res.password+'</b> and username is <b>'+res.username+'. Click to <a href="/parentlogin">LOG IN</a></b></p><button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>');
                }
            })  
            } 
        })
