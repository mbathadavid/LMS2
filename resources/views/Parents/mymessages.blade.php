...
<h6>The Messages you have send</h6>
        ...
        <tbody id="notificationstablebody">
            @foreach($mymessages as $mymessage)
                <tr class="w3-grey">
                    ...
                    <td>
                        @if ($mymessage['replied'] == 0)
                            Not yet Replied
                        @else
                            <button class="btn btn-sm btn-info" id="viewrepliesbtn" msg="{{ $mymessage['message'] }}" value="{{ $mymessage['id'] }}"><i class="fas fa-eye"></i>&nbsp;Replies</button>
                        @endif
                    </td>
            ...
            $.ajax({
                ...
                success: function(res){
                   ...
                   if (res.status == 200) {
                    ...
                    window.location = "{{ route('parent.mymessages') }}";
                   } else {
